      ...
      <div className={style.all_projects}>
        ...
        <div className={style.project}>
          ...
          <div className={style.project_description_box}>
            ...
            <p className={style.project_description}>
              ...
              informational website from where users can get all the information
              cricket like match score updates, News, videos etc
            </p>
        ...
        <div className={style.project}>
          <div className={style.project_description_box}>
            ...
            <p className={style.project_description}>
              ...
              Product's Page, Product's Details Page, Payment Page,Cart Page and
              Checkout Page.This was a collaborative project built by team of 5
              members in 5 days.
            </p>
            <div className={style.project_button_box}>
              <a
        ...
        <div className={style.project}>
          ...
          <div className={style.project_description_box}>
            ...
            <p className={style.project_description}>
              This was an individual project. PharmEasy online store from where
              users can buy medicines and take services like lab tests etc. I
              Created this clone using React, HTML, CSS, Javascript and also
              used Chakra and Bootstrap for UI.
            </p>
            <div className={style.project_button_box}>
              <a
        ...
        {/* <div className={style.project}>
          <div className={style.project_description_box}>
            ...
            <p className={style.project_description}>
              This is a team project where we cloned most of the pages of the
              Lifestyle.com website. Lifestyle.com is an e-commerce website from
              where one can buy clothing and beauty-related products.
            </p>
            <div className={style.project_button_box}>
              <a
                href="https://lifestylestore-com-clone.vercel.app/"
